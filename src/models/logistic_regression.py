...
Usage:
    python -m src.models.logistic_regression             # uses 'cleveland'
    python -m src.models.logistic_regression combined_uci_heart
"""
...
print(f"🚀 Training Logistic Regression on dataset: {dataset_name}")
...
# Save model + metrics
model_path = os.path.join(RESULTS_DIR, f"logistic_regression_{dataset_name}_model.joblib")
metrics_path = os.path.join(RESULTS_DIR, f"logistic_regression_{dataset_name}_metrics.csv")
